...
public class Main {
  ...
  */
   ...
   * achieve this, you would use the visitor pattern. Traverses the tree to define all the Symbols 
   * and ensure they are valid. Symbol table will be implemented as a stack of scopes using the
   * wrapper that's also built into ANTLR; the ParseTreeProperty object.
   ...
   * boilerplate code when it's already been implemented in an intelligent fashion.
